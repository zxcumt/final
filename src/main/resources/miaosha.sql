...
Source Server         : duck服务器
Source Server Version : 50711
Source Host           : 121.42.155.141:3306
...
-- Records of address
-- ----------------------------
INSERT INTO `address` VALUES ('3', 'a', '北京市', '北京市', '东城区', '40', '姜灶', '18952247316', '1');
INSERT INTO `address` VALUES ('4', '2', '2', '2', '2', '40', '4', '4', '1');
INSERT INTO `address` VALUES ('5', '陈炎青', '北京市', '北京市', '东城区', '40', '矿大', '18952247316', '1');
INSERT INTO `address` VALUES ('8', '阿斯蒂芬', '江苏省', '徐州市', '云龙区', '40', '爱的色放', '18952247316', '1');
INSERT INTO `address` VALUES ('14', 'ASDF ', '北京市', '北京市', '东城区', '40', 'ASDF ', '18952247316', '0');
...
CREATE TABLE `area` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_avjji44lfbuxjgnallepdxn03` (`citycode`)
...
CREATE TABLE `city` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_l4rlfmrc19gifgrkbw53gapkm` (`code`),
  KEY `FK_8dsh55jc99g85yuckb4ruwfk7` (`provincecode`)
...
CREATE TABLE `collection` (
  ...
  CONSTRAINT `collection_ibfk_2` FOREIGN KEY (`good_id`) REFERENCES `goods` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of collection
-- ----------------------------
INSERT INTO `collection` VALUES ('1', '40', '6');
...
CREATE TABLE `goods` (
  ...
  `presentprice` double(10,0) DEFAULT '0',
  `content` varchar(255) DEFAULT NULL,
  `pastprice` decimal(10,0) DEFAULT NULL,
...
-- Records of goods
-- ----------------------------
INSERT INTO `goods` VALUES ('5', '巧克力蛋糕', '60', '60', '原材料：奶油(新西兰）、奶酪（法国）、车厘子（美国 ）、芒果（澳洲）、红心火龙果、薄荷叶', null, 'http://demo.cssmoban.com/cssthemes3/cpts_517_ty/images/g1.jpg', 'http://demo.cssmoban.com/cssthemes3/cpts_517_ty/images/s2.png', '0');
INSERT INTO `goods` VALUES ('6', '泡芙塔', '100', '150', '原材料：奶油(新西兰）、奶酪（法国）、车厘子（美国 ）、芒果（澳洲）、红心火龙果、薄荷叶', null, 'http://demo.cssmoban.com/cssthemes3/cpts_517_ty/images/g2.jpg', 'http://demo.cssmoban.com/cssthemes3/cpts_517_ty/images/g5.png', '0');
INSERT INTO `goods` VALUES ('8', '心愿', '98', '188', '\r\n原材料：奶油(新西兰）、奶酪（法国）、车厘子（美国 ）、芒果（澳洲）、红心火龙果、薄荷叶', null, 'http://www.vipcake99.com/up/pro/s/20174189232140847.jpg', 'http://www.vipcake99.com/up/cake/s/20174189222031392.jpg', '0');
INSERT INTO `goods` VALUES ('9', '红丝绒', '100', '228', '\r\n原材料：新西兰乳脂奶油、法国可可粉、美国蔓越莓、新西兰奶油奶酪', null, 'http://www.vipcake99.com/up/pro/s/20171141715178956.jpg', 'http://www.vipcake99.com/up/cake/s/20171141772687442.jpg', '0');
INSERT INTO `goods` VALUES ('10', '甜蜜年轮', '100', '268', '\r\n原材料：乳脂奶油(法国)、维也纳海绵坯、覆盆子果酱（美国)、樱桃（美国)、桑葚、覆盆子、蓝莓（..', null, 'http://www.vipcake99.com/up/pro/s/2017541125927855.jpg', 'http://www.vipcake99.com/up/cake/s/20175417493977275.jpg', '0');
INSERT INTO `goods` VALUES ('11', '黑白慕斯', '100', '168', '\r\n原材料：白巧克力(比利时)、乳脂奶油(新西兰)、黑巧克力(比利�r)、可可粉(法国)、君度酒(法国)', null, 'http://www.vipcake99.com/up/pro/s/201692615335711011.jpg', 'http://www.vipcake99.com/up/cake/s/201692615292249152.jpg', '0');
INSERT INTO `goods` VALUES ('12', '百利甜情人', '100', '168', '\r\n原材料：乳脂奶油(新西兰)、百利甜酒(爱尔兰)、玫瑰汁(云南)、黄油(新西兰)、有机草莓(或黄桃)', null, 'http://www.vipcake99.com/up/pro/s/20169261530899498.jpg', 'http://www.vipcake99.com/up/cake/s/20174189263885710.jpg', '0');
INSERT INTO `goods` VALUES ('13', '朗姆CHEESE', '98', '168', '\r\n原材料：乳脂奶油(新西兰)、芝士(新西兰)、朗姆酒、柠檬(美国)、砂糖(韩国)', null, 'http://www.vipcake99.com/up/pro/s/201711417155388981.jpg', 'http://www.vipcake99.com/up/cake/s/201711417105023427.jpg', '0');
INSERT INTO `goods` VALUES ('14', '提拉米苏', '100', '199', '\r\n原材料：Mascarpone、奶酪(新西兰)、咖啡酒(墨西哥)、咖啡(肯尼亚)、可可粉(法国)', null, 'http://www.vipcake99.com/up/pro/s/201692615212053756.jpg', 'http://www.vipcake99.com/up/cake/s/201692615214045636.jpg', '1');
INSERT INTO `goods` VALUES ('15', '栗蓉醇香', '100', '168', '\r\n原材料：板栗(中国)、乳脂奶油(新西兰)、黄油(比利时)、砂糖(韩国)', null, 'http://www.vipcake99.com/up/pro/s/201692615283040331.jpg', 'http://www.vipcake99.com/up/cake/s/201692615284955141.jpg', '0');
INSERT INTO `goods` VALUES ('16', '榴・芒', '100', '199', '\r\n原材料：榴莲（泰国）、芒果（澳洲及台湾）、巧克力（比利时）、新西兰奶油、砂糖(韩国)', null, 'http://www.vipcake99.com/up/pro/s/20176916142229444.jpg', 'http://www.vipcake99.com/up/cake/s/201692615164066911.jpg', '0');
INSERT INTO `goods` VALUES ('17', '澳洲芒果', '100', '188', '\r\n原材料：芒果（澳洲、中国台湾）、乳脂奶油（新西兰）、白巧克力（比利时）', null, 'http://www.vipcake99.com/up/pro/s/201692615203598060.jpg', 'http://www.vipcake99.com/up/cake/s/201692615394961982.jpg', '0');
INSERT INTO `goods` VALUES ('18', '蓝莓香脆', '100', '188', '\r\n原材料：蓝莓鲜果、北美蓝莓果自制的蓝莓酱、乳脂奶油(法国)、芝士(新西兰)', null, 'http://www.vipcake99.com/up/pro/s/201692615323423584.jpg', 'http://www.vipcake99.com/up/cake/s/201692615264273416.jpg', '0');
INSERT INTO `goods` VALUES ('19', '福果', '100', '188', '\r\n原材料：奶油(新西兰）、奶酪（法国）、蔓越橘干（美国 ）、覆盆子 （法国）、芒果（澳洲）、车..', null, 'http://www.vipcake99.com/up/pro/s/201711417125332225.jpg', 'http://www.vipcake99.com/up/cake/s/201711417131617338.jpg', '0');
INSERT INTO `goods` VALUES ('20', '福瑞', '100', '168', '\r\n原材料：乳脂奶油（新西兰）、白巧克力（比利时）、有机草莓、樱桃（美国)、黄桃（南非）、绿猕..', null, 'http://www.vipcake99.com/up/pro/s/20174189281486750.jpg', 'http://www.vipcake99.com/up/cake/s/20174189295126605.jpg', '0');
INSERT INTO `goods` VALUES ('21', '榛子巧克力', '100', '168', '\r\n原材料：榛子(美国/土耳其)、黑巧克力(比利�r)、乳脂奶油(新西兰)、砂糖(韩国)', null, 'http://www.vipcake99.com/up/pro/s/201692615185886085.jpg', 'http://www.vipcake99.com/up/cake/s/201692615191912526.jpg', '0');
INSERT INTO `goods` VALUES ('22', '黑格', '100', '168', '\r\n原材料：黑巧克力(比利�r)、乳脂奶油(新西兰)、白兰地(法国)', null, 'http://www.vipcake99.com/up/pro/s/201692615222772739.jpg', 'http://www.vipcake99.com/up/cake/s/201692615224114363.jpg', '0');
INSERT INTO `goods` VALUES ('23', '卡布奇诺', '100', '168', '\r\n原材料：乳脂奶油(新西兰)、咖啡粉(哥伦比亚)、咖啡豆(肯尼亚)、咖啡酒(墨西哥)、芝士(新西兰)、..', null, 'http://www.vipcake99.com/up/pro/s/201692615272410509.jpg', 'http://www.vipcake99.com/up/cake/s/201692615271725609.jpg', '0');
INSERT INTO `goods` VALUES ('24', '杏仁淡奶', '100', '168', '\r\n原材料：杏仁(美国)、乳脂奶油(新西兰)、黄油(比利时)、砂糖(韩国)', null, 'http://www.vipcake99.com/up/pro/s/201692615215639451.jpg', 'http://www.vipcake99.com/up/cake/s/201692615221127130.jpg', '0');
INSERT INTO `goods` VALUES ('25', '抹茶雪域', '100', '168', '\r\n原材料：抹茶粉（日本）、巧克力（比利时与瑞士的妙搭）、香草（马达加斯加）、乳脂奶油（新西兰..', null, 'http://www.vipcake99.com/up/pro/s/20174151628170070.jpg', 'http://www.vipcake99.com/up/cake/s/201741516282663428.jpg', '0');
INSERT INTO `goods` VALUES ('26', '可瑞斯', '100', '168', '\r\n原材料：芝士(新西兰)、乳脂奶油(新西兰)、黄油(新西兰)、白核桃(云南)', null, 'http://www.vipcake99.com/up/pro/s/201741516265450459.jpg', 'http://www.vipcake99.com/up/cake/s/201692615281855767.jpg', '0');
INSERT INTO `goods` VALUES ('27', '芝士斯诺', '100', '168', '\r\n原材料：乳脂奶油(新西兰)、芝士(新西兰)、黄油(新西兰)、白巧克力(比利时)', null, 'http://www.vipcake99.com/up/pro/s/201692615182349963.jpg', 'http://www.vipcake99.com/up/cake/s/201692615184122595.jpg', '0');
INSERT INTO `goods` VALUES ('28', '榴莲暗香', '100', '168', '\r\n原材料：白巧克力（比利时）、榴莲（泰国金枕头）、乳脂奶油（新西兰）', null, 'http://www.vipcake99.com/up/pro/s/20169261526338553.jpg', 'http://www.vipcake99.com/up/cake/s/201692615261679530.jpg', '0');
INSERT INTO `goods` VALUES ('29', '核桃雪域', '100', '168', '\r\n原材料：乳脂奶油(新西兰)、白核桃(云南)、黄油(比利时)、砂糖(韩国)', null, 'http://www.vipcake99.com/up/pro/s/201692615303599784.jpg', 'http://www.vipcake99.com/up/cake/s/201692615305255921.jpg', '0');
INSERT INTO `goods` VALUES ('30', '布朗尼', '100', '168', '\r\n原材料：黑巧克力(比利�r)、朗姆酒(牙买加)、乳脂奶油(新西兰)、开心果(美国)、榛子(美国)、腰果..', null, 'http://www.vipcake99.com/up/pro/s/20169261524093181.jpg', 'http://www.vipcake99.com/up/cake/s/201692615241277745.jpg', '0');
INSERT INTO `goods` VALUES ('31', '松子仁', '100', '168', '\r\n原材料：松子(俄罗斯)、乳脂奶油(新西兰)、可可粉(法国)、砂糖(韩国)', null, 'http://www.vipcake99.com/up/pro/s/201692615242867006.jpg', 'http://www.vipcake99.com/up/cake/s/201692615244292626.jpg', '0');
INSERT INTO `goods` VALUES ('32', '心语', '100', '168', '\r\n原材料：白巧克力(比利时)、乳脂奶油(新西兰)、椰蓉(菲律宾)、黄油(新西兰)', null, 'http://www.vipcake99.com/up/pro/s/201692615253923006.jpg', 'http://www.vipcake99.com/up/cake/s/201692615255012124.jpg', '0');
INSERT INTO `goods` VALUES ('33', '卡布奇诺（无糖）', '100', '168', '\r\n原材料：乳脂奶油(新西兰)、咖啡粉(哥伦比亚)、咖啡豆(肯尼亚)、咖啡酒(墨西哥)、芝士(新西兰)、..', null, 'http://www.vipcake99.com/up/pro/s/201692615174110995.jpg', 'http://www.vipcake99.com/up/cake/s/20169261518525733.jpg', '0');
INSERT INTO `goods` VALUES ('34', '松子仁（无糖）', '100', '168', '\r\n原材料：松子(俄罗斯)、乳脂奶油(新西兰)、可可粉(法国)、木糖醇', null, 'http://www.vipcake99.com/up/pro/s/201692615123991904.jpg', 'http://www.vipcake99.com/up/cake/s/201692615421172640.jpg', '0');
INSERT INTO `goods` VALUES ('35', '童趣', '100', '168', '\r\n原材料：奶油(新西兰）、砂糖(韩国)、芒果（澳洲及台湾）、巧克力脆豆（比利时）、棉花糖、黄油..', null, 'http://www.vipcake99.com/up/pro/s/20175281445581247.jpg', 'http://www.vipcake99.com/up/cake/s/20165269212716436.jpg', '0');
INSERT INTO `goods` VALUES ('36', 'Miss喵', '100', '228', '\r\n原材料：奶油(新西兰）、砂糖(韩国)、芒果（澳洲及台湾）、巧克力（比利时）', null, 'http://www.vipcake99.com/up/pro/s/201752817513312413.jpg', 'http://www.vipcake99.com/up/cake/s/20175301364991687.jpg', '0');
INSERT INTO `goods` VALUES ('37', '童真', '100', '228', '\r\n原材料：奶油(新西兰）、砂糖(韩国)、芒果（澳洲及台湾）、巧克力（比利时）、巧克力豆', null, 'http://www.vipcake99.com/up/pro/s/201752711213534210.jpg', 'http://www.vipcake99.com/up/cake/s/201753013113038727.jpg', '0');
INSERT INTO `goods` VALUES ('38', '芒果拿破仑', '100', '188', '\r\n原材料：奶油（新西兰）、黄油（法国）、卡仕达酱（马达加斯加）、蓝莓（智利）、蓝莓酱（智利）..', null, 'http://www.vipcake99.com/up/pro/s/201692615104933820.jpg', 'http://www.vipcake99.com/up/cake/s/201692615351128783.jpg', '0');
INSERT INTO `goods` VALUES ('39', '莓之恋', '100', '188', '\r\n原材料：乳脂奶油(新西兰)、新鲜的有机草莓、细砂糖(韩国)', null, 'http://www.vipcake99.com/up/pro/s/201711417121499501.jpg', 'http://www.vipcake99.com/up/cake/s/20171141713949528.jpg', '0');
INSERT INTO `goods` VALUES ('40', '黑森林', '100', '168', '\r\n原材料：巧克力(比利�r)、乳脂奶油(新西兰)、黑车厘子(美国)、樱桃白兰地(荷兰)、砂糖(韩国)', null, 'http://www.vipcake99.com/up/pro/s/201692615232667713.jpg', 'http://www.vipcake99.com/up/cake/s/201692615233959832.jpg', '0');
INSERT INTO `goods` VALUES ('41', '草莓轻芝士', '100', '188', '\r\n原材料：新鲜有机草莓、乳脂奶油(新西兰)、芝士(新西兰)、黄油(新西兰)、坚果酥底、砂糖(韩国)', null, 'http://www.vipcake99.com/up/pro/s/201612917403147835.jpg', 'http://www.vipcake99.com/up/cake/s/201612917464162497.jpg', '0');
INSERT INTO `goods` VALUES ('42', '草莓拿破仑', '100', '188', '\r\n原材料：新鲜有机草莓、手工酥皮、卡仕达酱（马达加斯加）、奶油、黄油（法国）、砂糖(韩国)', null, 'http://www.vipcake99.com/up/pro/s/201612917392180041.jpg', 'http://www.vipcake99.com/up/cake/s/201612917453832639.jpg', '0');
...
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES ('10', '1715303078', '40', '2017-06-24 20:13:04.315000', '北京市北京市东城区姜灶', 'a', '18952247316', '188', '待发货');
INSERT INTO `orders` VALUES ('11', '0626297285', '40', '2017-06-26 11:42:25.739000', '北京市北京市东城区姜灶', 'a', '18952247316', '356', '已支付');
...
CREATE TABLE `orders_goods` (
  ...
  `sinplePrice` double DEFAULT NULL,
  `size` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `order_id` (`order_id`),
  KEY `good_id` (`good_id`),
  CONSTRAINT `orders_goods_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`),
  CONSTRAINT `orders_goods_ibfk_2` FOREIGN KEY (`good_id`) REFERENCES `goods` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of orders_goods
-- ----------------------------
INSERT INTO `orders_goods` VALUES ('6', '10', '8', '1', '188', '2');
INSERT INTO `orders_goods` VALUES ('7', '11', '13', '1', '168', '1');
INSERT INTO `orders_goods` VALUES ('8', '11', '8', '1', '188', '1');
...
CREATE TABLE `province` (
  ...
  `name` varchar(20) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_m0v4y4pmr6gsfpvjl1b3i56sr` (`code`)
...
CREATE TABLE `shoppingcart` (
  ...
  KEY `user_id` (`user_id`),
  KEY `good_id` (`good_id`),
  CONSTRAINT `shoppingcart_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `shoppingcart_ibfk_2` FOREIGN KEY (`good_id`) REFERENCES `goods` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of shoppingcart
-- ----------------------------
INSERT INTO `shoppingcart` VALUES ('35', '40', '9', '1', '1', '1');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('40', '467942350@qq.com', '123');
INSERT INTO `user` VALUES ('63', '6666asdf677777', '6666');
